...
<body>
    ...
    <a type="button" class="btn btn-primary btn-sm position-relative" style="margin-left: 1240px; margin-top: 0.5%; margin-bottom: 0.5%;" href="{{route('new_modelo')}}">ADICIONAR +</a>
            ...
            <tbody>
                    @foreach ($Modelos as $model)
                        <tr>
                            <td>{{$model->modelo}}</td>
                            <td class="row">
                                <form method="GET" action="{{route('show_modelo', ['id'=>$model->id])}}">
                                ...
                                <form method="GET" action="{{route('edite_modelo', ['id'=>$model->id])}}">
                                    <button class="btn" type="submit">
                                ...
                                <form method="GET" action="{{route('delete_modelo', ['id'=>$model->id])}}">
                                    <button class="btn" type="submit">
