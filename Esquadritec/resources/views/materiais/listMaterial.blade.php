        ...
        <table class="table table-sm center">
            ...
            <tbody>
                ...
                <tr class="text-white">
                    ...
                    <td class="row">
                        <form method="GET" style="margin-left: 31%;" action="{{route('show_material', ['id'=>$material->id])}}">
                            <button class="btn" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-card-list text-white" viewBox="0 0 16 16">
                                    <path
                        ...
                        <form method="GET" action="{{route('delete_material', ['id'=>$material->id])}}">
                            <button class="btn" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-trash text-white" viewBox="0 0 16 16">
                                    <path
