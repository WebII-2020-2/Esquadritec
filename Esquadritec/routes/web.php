...
Route::post('/dashboard/new_material/do', [Material::class, 'create'])->name('new_material_do')->middleware('Validate');

Route::get('/dashboard/new_cliente', [Cliente::class, 'create'])->name('new_cliente')->middleware('Validate');
Route::post('/dashboard/new_cliente/do', [Cliente::class, 'store'])->name('new_cliente_do')->middleware('Validate');
