...
<body>
    ...
    <div class="div_botao col-lg-12">
        <a type="button" class="botao" href="{{ route('new_unidade') }}">ADICIONAR +</a>
    </div>
        ...
        <table class="tabela tabela_lista">
            ...
            <tbody>
                @foreach ($unidade as $medida)
                    <tr>
                        <td class="table_rows">{{ $medida->unidade }}</td>
                        <td class="row_options">
                            <form method="GET" action="{{ route('show_unidade', ['id' => $medida->id]) }}">
